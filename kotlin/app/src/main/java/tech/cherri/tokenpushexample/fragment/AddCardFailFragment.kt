...
class AddCardFailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_add_card_fail, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        backToLoginBtn.setOnClickListener(View.OnClickListener { v: View? ->
            ...
            fragmentTransaction.remove(this@AddCardFailFragment)
        ...
        if (jSONObjectResult != null && jSONObjectResult!!.optString(Constants.RESPONSE_CALLBACK_URL_KEY) != null && jSONObjectResult!!.optString(
